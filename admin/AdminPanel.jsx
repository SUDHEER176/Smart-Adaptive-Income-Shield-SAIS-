      ...
      {stats && (
        <div className="metrics-grid">
          <div className="metric-card">
            <h3>👥 Total Users</h3>
            <value className="metric-value">{stats.totalUsers}</value>
          </div>
          <div className="metric-card">
            <h3>📋 Total Claims</h3>
            <value className="metric-value">{stats.totalClaims}</value>
          </div>
          <div className="metric-card">
            <h3>💸 Total Payout</h3>
            <value className="metric-value">₹{stats.totalPayout.toLocaleString()}</value>
          </div>
          <div className="metric-card">
            <h3>🎯 Avg Behavior Score</h3>
            <value className="metric-value">{Math.round(stats.avgBehaviorScore)}</value>
          </div>
          <div className="metric-card alert">
            <h3>🚨 High Risk Users</h3>
            <value className="metric-value">{stats.highRiskUsers}</value>
          </div>
        </div>
      )}
