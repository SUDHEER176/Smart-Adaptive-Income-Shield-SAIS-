...
import { simulationService, predictionService } from '../api';
        ...
        <div className="simulation-result">
          ...
          <div className="result-boxes">
            <div className="result-box">
              ...
              <value className="highlight-red">₹{simulation.simulation.withoutInsurance}</value>
              <p>💸 Total Loss</p>
            </div>
            <div className="result-box">
              <h3>With Insurance</h3>
              <value className="highlight-green">₹{simulation.simulation.withInsurance}</value>
              <p>✅ You Pay</p>
            </div>
            <div className="result-box">
              <h3>💰 Savings</h3>
              <value className="highlight-blue">₹{simulation.simulation.saved}</value>
